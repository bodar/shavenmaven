...
public class ResolverTest {
    ...
    public void supportsHttp() throws Exception{
        ...
        resolver.resolve(artifact("http://yatspec.googlecode.com/files/yatspec-87.jar"));
    ...
    public void supportsSpecificMavenRepository() throws Exception{
        ...
        assertThat(directory.listFiles().length, is(0));
        resolver.resolve(artifact("mvn://repo.bodar.com/com.googlecode.yadic:yadic:jar:116"));
        File[] files = directory.listFiles();
        assertThat(files.length, is(1));
    ...
    public void supportsUnspecifiedMavenRepository() throws Exception{
        ...
        assertThat(directory.listFiles().length, is(0));
        resolver.resolve(artifact("mvn:org.objenesis:objenesis:jar:1.2"));
        File[] files = directory.listFiles();
        assertThat(files.length, is(1));
